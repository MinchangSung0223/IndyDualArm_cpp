...
int main()
{
    ...
    while(1){
        ...
        cout<<"Jb_mu1 : "<<Jb_mu1<<endl;
        cout<<"Js_mu1 : "<<Js_mu1<<endl;
        
        cout<<"Jb_rel=";
        printMatrixRelativeJacobian(Jb_rel);
        cout<<"Js_rel=";
        printMatrixRelativeJacobian(Js_rel);
        ...
        cout<<"Jb_P1_=";
        printMatrixMatrix6d(Jb_P1);
        cout<<"Jb_Pm_=";
        printMatrixMatrix6d(Jb_Pm);
        cout<<"Js_P1_=";
        printMatrixMatrix6d(Js_P1);
        cout<<"Js_Pm_=";
        printMatrixMatrix6d(Js_Pm);
        ...
        cout<<"Pm_P1Js_=";
        printMatrixRelativeJacobian(Pm_P1Js);
        cout<<"Pm_P1Jb_=";        
        printMatrixRelativeJacobian(Pm_P1Jb);
        cout<<"vecPm_P1Js_=";
        printMatrixRelativeJacobianVec(vecPm_P1Js);
        cout<<"vecPm_P1Jb_=";
        printMatrixRelativeJacobianVec(vecPm_P1Jb);
        ...
        cout<<"vecdJs_=";        
        printMatrixDerivativeRelativeJacobianVec(vecdJs);
        cout<<"vecdJb_=";               
        printMatrixDerivativeRelativeJacobianVec(vecdJb);
        ...
        SE3 T_left = T_right*T_rel;
      //  Xd(0,3) = 0.2*cos(2*M_PI*t);
      //  Xd(1,3) = 0.2*sin(2*M_PI*t);
       ...
       // RelativeJVec qdot_rel =pinvJb_rel*Xe_rel + (Identity12x12- pinvJs_rel*Js_rel)*(-Js_dmu1);
        ...
        RelativeJVec qdot_rel =20.0*(Identity12x12- pinvJs_rel*Js_rel)*(-Js_dmu1);
